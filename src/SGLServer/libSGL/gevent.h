...
enum EventClass {
    ...
    SCROLL_EVENT    = 0x4000,
    ANY_EVENT       = ACTION_EVENT | KEY_EVENT2 | TIMER_EVENT | WINDOW_EVENT
                    | MOUSE_EVENT2 | CLICK_EVENT | TABLE_EVENT | SERVER_EVENT
...
enum EventType {
    ...
    MOUSE_CLICKED        = MOUSE_EVENT2 + 1,
    MOUSE_PRESSED        = MOUSE_EVENT2 + 2,
    MOUSE_RELEASED       = MOUSE_EVENT2 + 3,
    MOUSE_MOVED2          = MOUSE_EVENT2 + 4,
    MOUSE_DRAGGED        = MOUSE_EVENT2 + 5,
    MOUSE_ENTERED        = MOUSE_EVENT2 + 6,
    MOUSE_EXITED         = MOUSE_EVENT2 + 7,
    MOUSE_WHEEL_DOWN     = MOUSE_EVENT2 + 8,
    MOUSE_WHEEL_UP       = MOUSE_EVENT2 + 9,
    MOUSE_DOUBLE_CLICKED = MOUSE_EVENT2 + 10,

    KEY_PRESSED          = KEY_EVENT2 + 1,
    KEY_RELEASED         = KEY_EVENT2 + 2,
    KEY_TYPED            = KEY_EVENT2 + 3,
...
public:
    ...
    /**
     * Returns this event's class (major type such as MOUSE_EVENT2).
    ...
    /**
     * Returns the event's type (major type such as MOUSE_EVENT2).
    ...
    /**
     * Converts an event type such as MOUSE_EVENT2 to a string such as
     * "MOUSE_EVENT2".
     */
